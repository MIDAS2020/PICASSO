/*
 * FILE: Utils.java DATE OF CREATION: Thu Jan 09 14:14:35 2003 Copyright (c) Emmanuel Pietriga,
 * 2002-2011. All Rights Reserved Licensed under the GNU LGPL. For full terms see the file COPYING.
 * 
...
public class Utils {
  ...
  public static void initLookAndFeel() {
    ...
    // catch(Exception
    // ex){System.err.println("An error occured while trying to change the look and feel\n"+ex);}
    String key;
    Object okey;
  ...
  /**
   * increment a byte representing a char value with the following values (in order)
