 ...
 * @author Andy
 */
public class TEDPatternGenerator {
	...
	public TEDPatternGenerator(PatternSetInfo patternSetInfo, PragueIndex pi)
			throws IOException {
		...
		patternsBw = Files.newWriter(path.getTEDPatterns(), Charsets.US_ASCII);
		vertexLocBw = Files.newWriter(path.getTEDPatternsVertexLoc(),
				Charsets.US_ASCII);
	...
	public void execute() throws Exception {
		...
		//extractTEDPatterns(patternSetInfo.getMinSize(),patternSetInfo.getMaxSize(), patternSetInfo.getFreqNum());
                
                extractTEDPatterns(patternSetInfo.getMinSize(),patternSetInfo.getMaxSize(), patternSetInfo.getNumberOfPatterns());
	...
	private void extractTEDPatterns(int minSize, int maxSize, int limit)
			throws Exception {
		DiversePatternGenerator divPatternsG = new DiversePatternGenerator(minSize, maxSize,limit, pi, this);
		divPatternsG.extractPatterns();
	}
